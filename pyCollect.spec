...
a = Analysis(
    ...
    hiddenimports=['PyQt5.sip', 'PyQt5.QtCore', 'PyQt5.QtWidgets', 'PyQt5.QtGui', 'pyqtgraph', 'serial', 'serial.tools', 'serial.tools.list_ports',
                   'pycollect_qt_gui', 'config_loader', 'collapsible_section', 'collector_worker',
                   'csv_conversion_worker', 'notes_manager', 'port_scan_worker', 'live_monitor_plot',
                   'gui_theme_mixin', 'gui_build_mixin', 'gui_review_mixin',
                   'gui_catalog_mixin', 'gui_capture_mixin', 'gui_plot_mixin',
                   'local_control'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
